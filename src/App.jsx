...
export default function App() {
  ...
  const [projects, setProjects] = useState([
    {
      id: 1,
      name: 'Attending Leakage Works to Water Supply Distribution Zone 2 and Pumping Main',
      village: 'Sivakasi',
      budget: '₹10.00 Lakh',
      progress: 'Not Published',
      status: 'Tender',
      photo: 'https://www.waterandwastewater.com/wp-content/uploads/2024/12/pump-station-scada-system-1024x632.jpg',
      lastUpdated: '07-Sep-2026',
    },
    {
      id: 2,
      name: 'Construction of Additional Building for Common Kitchen – CM Breakfast Scheme, Nehru Colony',
      village: 'Thiruthangal',
      budget: '₹13.00 Lakh',
      progress:'Not Published',
      status: 'Tender',
      photo: 'https://tse3.mm.bing.net/th/id/OIP.Wpz-nq_LIHEFATYO4QCORwHaEK?r=0&pid=Api&P=0&h=180',
      lastUpdated: '04-Sep-2026',
    },
    {
      id: 3,
      name: 'Supply & Erection of 30 HP Sub Motor at Sokkalinga Poonga',
      village: 'Sattur',
      budget: '₹5.60 Lakh',
      progress:'Not Published',
      status: 'Tender',
      photo: 'https://bharatiindustries.com/images/erection-and-commissioning-of-pumps-motors2.jpg',
      lastUpdated: '2026-08-22',
    },
    {
      id: 4,
      name: 'Children’s Park and Play Field – Kavitha Nagar',
      village: 'Ward 24, Thiruthangal',
      budget: '₹19 Lakh',
      progress: 100,
      status: 'Completed',
      photo: 'https://www.sakshi.com/gallery_images/2024/08/29/LB%20Nagar%20Oxygen%20Park%20Photos_9.jpg',
      lastUpdated: '2026-09-09',
    },
    {
      id: 5,
      name: 'Sellaimman Koil Oorani Water Body Rejuvenation',
      village: 'Sellaimman Koil Oorani, Thiruthangal',
      budget: '₹60 Lakh',
      progress: 100,
      status: 'completed',
      photo: 'https://3.bp.blogspot.com/-o_ezmqpfrHs/UiGItNvvvgI/AAAAAAAAAGo/3DgWQ2sVGmQ/s1600/VETTUVANAM++KOIL+KULAM.jpg',
      lastUpdated: '2026-09-09',
    },
  ]);
